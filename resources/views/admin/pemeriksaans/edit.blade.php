...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.pemeriksaan.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.pemeriksaans.update", [$pemeriksaan->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="subjektif">{{ trans('cruds.pemeriksaan.fields.subjektif') }}</label>
                <input class="form-control {{ $errors->has('subjektif') ? 'is-invalid' : '' }}" type="text" name="subjektif" id="subjektif" value="{{ old('subjektif', $pemeriksaan->subjektif) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('objektif') ? 'is-invalid' : '' }}" type="text" name="objektif" id="objektif" value="{{ old('objektif', $pemeriksaan->objektif) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('penilaian') ? 'is-invalid' : '' }}" type="text" name="penilaian" id="penilaian" value="{{ old('penilaian', $pemeriksaan->penilaian) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('plan') ? 'is-invalid' : '' }}" type="text" name="plan" id="plan" value="{{ old('plan', $pemeriksaan->plan) }}" required>
                @if($errors->has('plan'))
                    <div class="invalid-feedback">
                        {{ $errors->first('plan') }}
                    </div>
