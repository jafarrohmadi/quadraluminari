...
<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <span class="navbar-brand-full"><h1><img src="{{asset('img/logo.png')}}" style="display:block;width: 80%; height: auto ;margin-left: auto;
  margin-right: auto; margin-bottom: 10%"></h1></span>
        <span class="navbar-brand-minimized"><h1><img src="{{asset('img/logo.png')}}" style="display:block;width: 80%; height: auto ;margin-left: auto;
  margin-right: auto; margin-bottom: 10%"></h1></span>
    </a>
